                                        ...
                                        <ul class="nav nav-tabs nav-tabs-neutral justify-content-center" role="tablist" data-background-color="orange">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#home" role="tab">
                                                    <i class="now-ui-icons objects_umbrella-13"></i> Success
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#profile" role="tab">
                                                    <i class="now-ui-icons shopping_cart-simple"></i> On progress
                                                </a>
                                            </li>
                                                    ...
                                                    <table class="table">
                                                      ...
                                                      @foreach($transaksi_list as $transaksi)
                                                        ...
                                                        @if($transaksi->status == 'Belum')
                                                          ...
                                                          <td><a href="/riview/{{$transaksi->id}}"><button class="btn btn-link btn-primary">Riview</button></a></td>
                                                        @endif
                                                        </tr>
